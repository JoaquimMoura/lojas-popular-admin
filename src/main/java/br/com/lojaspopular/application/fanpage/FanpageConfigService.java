...
public class FanpageConfigService {
  ...
  private FanpageConfig createDefault() {
    FanpageConfig config = FanpageConfig.builder()
        ...
        .heroDescription("Kits completos de sala, cozinha, quarto e escritorio com condicoes especiais. Entregamos e montamos em tempo recorde para voce usar no mesmo dia.")
        ...
        .offersDescription("Conjuntos selecionados para renovar sua casa com descontos exclusivos da fanpage.")
        .combosTitle("Combos planejados")
        .combosDescription("Kits completos com armarios, mesas, cadeiras e acessorios que cabem no seu espaco e no seu bolso.")
        .ctaTitle("Atendimento personalizado")
        .ctaDescription("Conte para a nossa equipe como e o seu comodo e receba um projeto com os moveis perfeitos para o seu espaco.")
        .build();

    List<FanpageBenefit> benefits = List.of(
        FanpageBenefit.builder().title("Montagem rapida").description("Equipe propria e agenda flexivel.").build(),
        FanpageBenefit.builder().title("Entrega expressa").description("Despacho em ate 48h na capital.").build(),
        FanpageBenefit.builder().title("Pagamento facilitado").description("Parcelamento em ate 12x sem juros.").build());
    ...
    List<FanpageCollectionBlock> collections = List.of(
        FanpageCollectionBlock.builder()
            ...
            .imageUrl("https://images.unsplash.com/photo-1484100356142-db6ab6244067?auto=format&fit=crop&w=1200&q=80")
            .build(),
        FanpageCollectionBlock.builder()
            .name("Cozinhas Compactas")
            .description("Kits completos com armarios, balcoes e torres.")
            .imageUrl("https://images.unsplash.com/photo-1588853431081-02531f0526eb?auto=format&fit=crop&w=1200&q=80")
            .build(),
        FanpageCollectionBlock.builder()
            .name("Quartos Aconchegantes")
            .description("Guarda-roupas, camas box e cabeceras combinando.")
            .imageUrl("https://images.unsplash.com/photo-1505692794403-55b39b05e08c?auto=format&fit=crop&w=1200&q=80")
            .build());
